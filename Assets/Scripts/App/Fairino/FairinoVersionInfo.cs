namespace KineTutor3D.App.Fairino
{
    public readonly struct FairinoVersionInfo
    {
        ...
        public string ControllerIp { get; }

        public FairinoVersionInfo(string firmwareVersion, string sdkVersion)
            : this(firmwareVersion, sdkVersion, string.Empty, string.Empty, string.Empty, string.Empty)
        {
        }
            ...
            string controllerIp)
        {
            ...
            ControllerIp = controllerIp ?? string.Empty;
        }
    }
}
